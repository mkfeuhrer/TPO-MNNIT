...
public class FoldingCellListAdapter extends ArrayAdapter<UserData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.time.setText(item.getRegnum());
        viewHolder.date.setText(item.getBatch());
        viewHolder.fromAddress.setText(item.getBranch());
        viewHolder.toAddress.setText(item.getCountry());
        viewHolder.requestsCount.setText(item.getDob());
        viewHolder.pledgePrice.setText(item.getGender());
